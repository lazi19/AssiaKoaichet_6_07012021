...
app.set('port', port);  // Set du port de connection. app.set('cle' , valeur) (app.set('key', value))  pour stocker des variables et pouvoir les recuperer (avec app.get('key')) afin de les utiliser plus tard (un peux comme localStorage)
