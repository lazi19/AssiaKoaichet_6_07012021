/*
 // Charge (ou importe)le module express 
...
app.post('/api/auth/signup', auth, (req, res, next) => {
  ...
  app.post('/api/sauces', auth, (req, res, next) => { 
   ...
   //creation de route GET pour sauce. Permet de récuperer toutes les sauces de la base MongoDB
    app.get('/api/sauces', auth, (req, res, next) => {  // le premier argument de post '/api/stuff' est la route (l'utilisateur demande des informations )
  ...
  // récupérer une seul sauce, identifiée par son id depuis la base MongoDB
    app.get('/api/sauces/:id', auth, (req, res, next) => {  // le premier argument de get '/api/stuff' est la route
